...
#define I2C_DEV_HWMON_DIR          I2C_SYSFS_DEVICES"/%s/hwmon"
#define PSU_FAN_CONFIG_1_2         "fan_config_1_2"
#define PSU_FAN_COMMAND1           "fan_command_1"
#define PSU_FAN_COMMAND2           "fan_command_2"
#define PSU_STATUS0_MFR            "status_mfr_specific"
#define PSU_REG_LENGTH             "pmbus_psu_reg_length"
#define PSU_BLOCK_READ             "pmbus_psu_block_read"
#define PSU_EEPROM                 I2C_SYSFS_DEVICES"/%s/eeprom"

#define PMBUS_DEBUG_FS(ent)   "/sys/kernel/debug/pmbus/hwmon%s/"#ent
#define PSU_STATUS0_WORD      PMBUS_DEBUG_FS(status0)
#define PSU_STATUS0_CML       PMBUS_DEBUG_FS(status0_cml)
#define PSU_STATUS0_FAN_1_2   PMBUS_DEBUG_FS(status0_fan12)
#define PSU_STATUS0_INPUT     PMBUS_DEBUG_FS(status0_input)
#define PSU_STATUS0_IOUT      PMBUS_DEBUG_FS(status0_iout)
#define PSU_STATUS0_TEMP      PMBUS_DEBUG_FS(status0_temp)
#define PSU_STATUS0_VOUT      PMBUS_DEBUG_FS(status0_vout)
...
int psu_block_read(const char* suid, uint8_t reg, uint8_t data_len, char *data);
